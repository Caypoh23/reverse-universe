...
namespace Player.Old
{
    public class PlayerController : MonoBehaviour
    {
        ...
        {
            _movementInputDirection = UnityEngine.Input.GetAxisRaw("Horizontal");
            ...
            if (UnityEngine.Input.GetButtonDown("Horizontal") && _isTouchingWall)
            {
            ...
            if (_checkJumpMultiplier && !UnityEngine.Input.GetKey(KeyCode.Space))
            {
